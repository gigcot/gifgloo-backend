...
from credit_account.application.ports.inbound.get_history import GetCreditHistoryCommand, GetCreditHistoryPort, GetCreditHistoryResult
...
class GetCreditHistoryService(GetCreditHistoryPort):
    ...
    def execute(self, command: GetCreditHistoryCommand) -> GetCreditHistoryResult:
        ...
        return GetCreditHistoryResult(credit_account.transactions)