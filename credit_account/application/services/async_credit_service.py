...
class AsyncCreditService:
    ...
    async def has_enough_credit(self, user_id: str) -> bool:
        credit_account = await self._credit_account_repo.find_credit_by_user_id(user_id)
    ...
    async def deduct(self, user_id: str) -> None:
        ...
        credit_account = await self._credit_account_repo.find_credit_by_user_id(user_id, for_update=True)
